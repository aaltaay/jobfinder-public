  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium tracking-tight transition-opacity duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost:
          "rounded-full bg-transparent text-muted-foreground hover:bg-muted hover:text-foreground min-h-11",
        outline:
          "rounded-full border border-border bg-card text-foreground hover:bg-muted",
