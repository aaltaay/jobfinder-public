/**
 * Low-token JD-to-evidence planner.
 *
 * Mirror of supabase/functions/jobfinder-resume-tailor/planner.ts (no shared
 * package yet — keep both in sync, same convention as tailorBaseline.ts).
 *
